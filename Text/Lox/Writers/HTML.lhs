Transforming Formulas to HTML (`Text.Lox.Writers.HTML`)
-------------------------------------------------------

There is clear potential for abstracting some of the common features of the two
writer modules.
...
> termAsHTML (Operation op t1 t2) =
>     termAsHTML t1 ++ operatorEntity op ++ termAsHTML t2
...
> application id ts =
>     id:'(':(foldl1 (\ x y -> x ++ ", " ++ y) (map termAsHTML ts)) ++ ")"
