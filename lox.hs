{-# LANGUAGE CPP #-}
{-
Copyright (C) 2013 Johannes Emerich <johannes@emerich.de>

The source in this file is based substantively on pandoc.hs by John
MacFarlane:
...
{- |
   Module      : Main
   Copyright   : Copyright (C) 2006-2013 John MacFarlane, 2013 Johannes Emerich
   License     : GNU GPL, version 2 or above

   Maintainer  : Johannes Emerich <johannes@emerich.de>
   Stability   : alpha
...
copyrightMessage = "\nCopyright (C) 2013 Johannes Emerich\n" ++
                    "Web:  https://github.com/knuton/lox\n" ++
    ...
    , Option "v" ["version"]
                 (NoArg
                  (\_ -> do
                     ...
                     UTF8.hPutStrLn stdout (prg ++ " " ++ loxVersion ++
                       "\nBuilt on Pandoc " ++ pandocVersion ++
...
main = do
  ...
  doc <- readSources sources >>=
           handleIncludes' . preprocessDocument . convertTabs . intercalate "\n" >>=
           reader readerOpts
